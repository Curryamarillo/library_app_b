...
class LoanControllerTests {
    ...
    private final LocalDateTime returnDate = (LocalDateTime.of(2024, 1, 1, 12, 0, 0, 0));
    ...
    void createLoanTest() throws Exception {
        ...
        result.andExpect(status().isCreated())
                ...
                .andExpect(jsonPath("$.loanDate").value("2023-01-01T00:00:00"))
                .andExpect(jsonPath("$.returnDate").value("2024-01-01T12:00:00"));
    ...
    void findByUserId_Successful() throws Exception {
        ...
        mockMvc.perform(get("/loans/user/{id}", 1L)
                ...
                .andExpect(jsonPath("$[0].userId").value(loanResponseDTO1.userId()))
                .andExpect(jsonPath("$[0].bookId").value(loanResponseDTO1.bookId()))
                .andExpect(jsonPath("$[0].loanDate").value("2023-01-01T00:00:00")) // Ajustar aquí
                .andExpect(jsonPath("$[0].returnDate").value("2024-01-01T12:00:00")) // Ajustar aquí

                .andExpect(jsonPath("$[1].id").value(loanResponseDTO2.id()))
                .andExpect(jsonPath("$[1].userId").value(loanResponseDTO2.userId()))
                .andExpect(jsonPath("$[1].bookId").value(loanResponseDTO2.bookId()))
                .andExpect(jsonPath("$[1].loanDate").value("2023-01-01T00:00:00")) // Ajustar aquí
                .andExpect(jsonPath("$[1].returnDate").value("2024-01-01T12:00:00")); // Ajustar aquí
    }
